...
router.get("/users/teams", isAuthenticated, isAdmin, async (req: Request, res: Response) => {
  try {
...
router.post("/import/riders", isAuthenticated, isAdmin, async (req: Request, res: Response) => {
  try {
...
router.post("/import/races", isAuthenticated, isAdmin, async (req: Request, res: Response) => {
  try {
